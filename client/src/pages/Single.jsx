...
const Single = () => {
  ...
  const handleLike = async () => {
    try {
      const response = await axios.post(process.env.REACT_APP_BACKEND_URL + `api/posts/${postId}/like`,{
        headers: {
          Authorization: `Bearer ${token}`,
        }
      });
  ...
  return (
    <div className="single">
      ...
      <div>
        ...
        <button className="commentBtn" onClick={handleAddComment}>Add Comment</button>
         </div>
    </div>
  );
};
